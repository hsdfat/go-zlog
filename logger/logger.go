...
// Initialize rebuilds the global Log with the given configuration. Call this once
// the desired sinks are known (e.g. after reading config from netconf). The shared
// atomic level is preserved, so SetLevel continues to work afterward.
